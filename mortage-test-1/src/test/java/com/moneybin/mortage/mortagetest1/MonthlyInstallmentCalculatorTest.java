...
import com.moneybin.mortage.mortagetest1.service.MonthlyInstallmentCalculatorImpl;
...
@SpringBootTest
public class MonthlyInstallmentCalculatorTest {

	private MonthlyInstallmentCalculator monthlyInstallmentCalculator;

	@Before
	public void setUp() {
		monthlyInstallmentCalculator = new MonthlyInstallmentCalculatorImpl();
	}

	@Test
	public void shouldCalculateMonthlyInstalment() {
		final String fileContent = "John,100000,10,5";
		Optional<String> message = monthlyInstallmentCalculator.calculate(fileContent);
